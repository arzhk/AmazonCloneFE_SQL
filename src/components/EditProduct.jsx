...
function EditProduct(props) {
  ...
  const postDataHandler = async () => {
    setIsLoading(true);
    let modifiedProduct = { ...productInfo };
    delete modifiedProduct.created_at;
    delete modifiedProduct.updated_at;
    delete modifiedProduct.id;
    try {
      const response = await fetch(`${env.API_URL}${productInfo.id}`, {
        method: "PUT",
